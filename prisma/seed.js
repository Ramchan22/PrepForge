...
async function main() {
  ...
  // 2. Default SMTP Config (Brevo Relay - Port 587 STARTTLS for Cloud Compatibility)
  await prisma.smtpConfig.upsert({
    ...
    update: {
      ...
      passwordEncrypted: 'enc:bYbSaSivlr7AF0va:2SSqDGAxFeS4MKdYLEY8+Q==:NJoxcdV3NND8jnybAk8FHg==',
      secure: false,
